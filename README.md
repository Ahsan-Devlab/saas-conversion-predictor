...
* **Feature Scaling (StandardScaler):** Normalizing data so features with large numbers (session minutes) do not mathematically overpower features with small numbers (login counts).
* **Data Visualization:** Plotting user clusters and dynamic markers using Matplotlib.
